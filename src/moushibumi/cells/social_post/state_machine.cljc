(ns moushibumi.cells.social-post.state-machine
  "Phase state machine for the 申文 — Citizen Democratic-Participation Concierge social_post cell — the publication membrane that
