...
(defn collection
  [name]
  (str "com.etzhayyim.moushibumi." name))

(def cell-specs {
  :target_registry {:legacy-cell "target-registry"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "target_registry")]
     :required-gates common-gates
     :trigger "manifest cell target_registry"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :voter_info {:legacy-cell "voter-info"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "voter_info")]
     :required-gates common-gates
     :trigger "manifest cell voter_info"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :opportunity_match {:legacy-cell "opportunity-match"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "opportunity_match")]
     :required-gates common-gates
     :trigger "manifest cell opportunity_match"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :intake {:legacy-cell "intake"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "intake")]
     :required-gates common-gates
     :trigger "manifest cell intake"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :compose {:legacy-cell "compose"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "compose")]
     :required-gates common-gates
     :trigger "manifest cell compose"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :submit {:legacy-cell "submit"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "submit")]
     :required-gates common-gates
     :trigger "manifest cell submit"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :status_track {:legacy-cell "status-track"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "status_track")]
     :required-gates common-gates
     :trigger "manifest cell status_track"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
